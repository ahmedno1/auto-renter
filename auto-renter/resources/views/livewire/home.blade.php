<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
    <section class="relative bg-black text-white">
        <div class="container mx-auto px-6 lg:px-16 py-16 flex flex-col-reverse lg:flex-row items-center gap-12">
            <div class="flex-1 text-center lg:text-left">
                ...
                <div class="mt-6 flex flex-wrap justify-center lg:justify-start gap-4">
                    <a href="#cars" class="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-full shadow-lg transition">
                        Rent a Car
                    </a>
        ...
        <svg class="absolute  top-170 z-0 inset-0 w-full h-[200px]" viewBox="0 0 1440 520" preserveAspectRatio="none" aria-hidden="true">
            <path d="M0,0 H1440 V320
             C1080,520 360,520 0,320
             Z" fill="black" />
        </svg>
    </section>
